...
function fetchCryptoData() {
  return _fetchCryptoData.apply(this, arguments);
}
function _fetchCryptoData() {
  _fetchCryptoData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var apikey, url, headers;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          apikey = "75f505f3-1022-42ca-82e1-a626f71b16e9";
          url = "https://pro-api.coinmarketcap.com/v1/cryptocurrency/info?symbol=CHEEKS";
          headers = new Headers();
